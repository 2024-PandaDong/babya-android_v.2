...
class TodoCategoryAdapter(
    val flash: (position: Int) -> Unit,
    val categoryList: List<String>,
    val context: Context,
    val selectedItemPosition: Int
) : RecyclerView.Adapter<TodoCategoryAdapter.CategoryViewHolder>() {
    inner class CategoryViewHolder(private val binding: ItemTodoListTagBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        val binding =
            ItemTodoListTagBinding.inflate(LayoutInflater.from(parent.context), parent, false)
