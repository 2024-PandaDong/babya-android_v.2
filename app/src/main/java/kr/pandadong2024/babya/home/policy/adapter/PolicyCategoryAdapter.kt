...
class PolicyCategoryAdapter(val flash :(position:Int)->Unit, val categoryList : List<String>, val selectedItemPosition : Int) : RecyclerView.Adapter<PolicyCategoryAdapter.CategoryViewHolder>() {
